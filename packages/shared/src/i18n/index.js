export const translations = {
    en: {
        ...
        home: {
            ...
            pendingSync: (count) => `${count} pending offline sync`,
        },
        logger: {
            title: (eventName) => `Log ${eventName}`,
            time: 'Time of Event',
            ...
            cancel: 'Cancel',
            saving: 'Saving...',
            loggedSuccess: (eventName) => `${eventName} logged successfully!`,
        },
        analytics: {
            ...
            vomitCount: (count) => `${count} vomiting incidents recorded`,
            medCount: (count) => `${count} medications administered`,
            daysNoPoop: (days) => `${days} days without poop recorded`,
        ...
        importer: {
            ...
            success: (count) => `Successfully imported ${count} historical events!`,
        },
        settings: {
            back: 'Today',
            title: 'Settings',
            ...
            korean: '한국어',
            household: 'Household',
            householdCount: (people, pets) => `${people} ${people === 1 ? 'person' : 'people'} · ${pets} ${pets === 1 ? 'pet' : 'pets'}`,
            invite: 'Invite',
            people: 'People',
        ...
        invite: {
            ...
            pending: 'Pending',
            revoke: 'Revoke',
            pendingHelp: 'Anyone with the code can log events. Only you can rename the household or remove people.',
            codeCopied: 'Code copied',
            codeCopiedSub: (code) => `${code} · expires in 7 days`,
            inviteRevoked: 'Invite revoked',
            inviteRevokedSub: (code) => `${code} will no longer work.`,
        },
        auth: {
            welcomeTitle: 'Dooty',
            ...
            signupStep1: {
                ...
                disclaimer: 'By continuing you agree we will store an unreasonable amount of data about your dog’s bowels.',
            },
            signupStep2: {
                back: 'Back',
                stepCount: '2 / 2',
                ...
                householdHelp: 'Everyone you invite joins this household and can log for any pet in it.',
                size: 'Size',
                sizes: {
                    S: { label: 'S', kg: '– 10kg' },
                    M: { label: 'M', kg: '10–20' },
            ...
            joinStep2: {
                ...
                summarySubtitle: (count, role) => `${count} · you'll be ${role}`,
                title: 'Tell them who you are',
                subtitle: 'Your name shows up next to every event you log, so pick what the household will recognise.',
                yourName: 'Your name',
                ...
                footerDisclaimer: 'The owner will be told you joined. You can leave the household at any time.',
            },
            ...
            inviteCodeHint: 'Ask your household owner to generate an invite code from their Settings > Family Members tab.',
    ...
    ko: {
        ...
        streak: {
            badge: (days) => `${days}일 연속 기록 중!`,
            subtitle: '매일 꾸준히 기록해서 건강한 루틴을 만들어요!',
        },
        home: {
            greeting: (petName) => `안녕, ${petName}! 🐾`,
            ...
            offlineMode: '오프라인 모드',
            pendingSync: (count) => `${count}개 항목 동기화 대기 중`,
        },
        logger: {
            title: (eventName) => `${eventName} 기록하기`,
            time: '기록 시간',
            ...
            cancel: '취소',
            saving: '저장 중...',
            loggedSuccess: (eventName) => `${eventName} 기록이 저장되었습니다!`,
        },
        analytics: {
            title: '배변 및 활동 분석',
            ...
            healthWatch: '건강 모니터링',
            vomitCount: (count) => `최근 구토 ${count}회 발생`,
            medCount: (count) => `최근 투약 ${count}회 완료`,
            daysNoPoop: (days) => `응가 미기록 ${days}일째`,
        ...
        importer: {
            ...
            success: (count) => `${count}개의 과거 기록을 성공적으로 가져왔습니다!`,
        },
        settings: {
            back: '오늘',
            title: '설정',
            ...
            korean: '한국어',
            household: '가족 공간',
            householdCount: (people, pets) => `${people}명 · 반려견 ${pets}마리`,
            invite: '초대',
            people: '구성원',
            inviteSomeone: '+ 초대하기',
            pets: '반려동물',
        ...
        invite: {
            ...
            pending: '대기 중인 초대',
            revoke: '취소',
            pendingHelp: '코드를 가진 사람은 누구나 기록할 수 있습니다. 가족 관리자만 이름을 바꾸거나 구성원을 삭제할 수 있습니다.',
            codeCopied: '코드 복사 완료',
            codeCopiedSub: (code) => `${code} · 7일 후 만료`,
            inviteRevoked: '초대 취소됨',
            inviteRevokedSub: (code) => `${code} 코드는 더 이상 사용할 수 없습니다.`,
        },
        auth: {
            welcomeTitle: 'Dooty',
            ...
            signupStep1: {
                ...
                strong: '안전',
                nextTheDog: '다음: 강아지',
                disclaimer: '계속 진행하면 강아지의 배변에 관한 상당한 양의 데이터를 저장하는 데 동의하게 됩니다.',
            },
            signupStep2: {
                back: '뒤로',
                stepCount: '2 / 2',
                ...
                householdHelp: '초대한 모든 사람이 이 가족에 합류하여 모든 반려동물에 대해 기록할 수 있습니다.',
                size: '크기',
                sizes: {
                    S: { label: 'S', kg: '– 10kg' },
                    M: { label: 'M', kg: '10–20' },
            ...
            joinStep2: {
                ...
                summarySubtitle: (count, role) => `${count} · 역할: ${role}`,
                title: '자신을 알려주세요',
                subtitle: '내가 기록한 모든 활동 옆에 내 이름이 표시되므로 가족이 알아볼 수 있는 이름을 선택하세요.',
                yourName: '이름',
                ...
                footerDisclaimer: '가족 관리자에게 참여 알림이 전송됩니다. 언제든지 가족에서 나갈 수 있습니다.',
            },
            signUpBtn: '회원가입 완료',
            signingUp: '가입 처리 중...',
            ...
            inviteCodeHint: '가족 관리자의 [설정 > 가족 멤버]에서 생성한 6자리 초대 코드를 입력하세요.',
            yourNameLabel: '내 이름',
