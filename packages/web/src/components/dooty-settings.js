...
let DootySettings = class DootySettings extends LitElement {
...
DootySettings = __decorate([
    customElement('dooty-settings')
], DootySettings);
export { DootySettings };
//# sourceMappingURL=dooty-settings.js.map