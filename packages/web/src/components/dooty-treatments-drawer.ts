...
export class DootyTreatmentsDrawer extends LitElement {
  @state() private name: string = '';
  @state() private dose: string = '';
  @state() private every: number = 30;
  ...
  render() {
    if (!appState.treatmentsDrawerOpen && !this.isClosing) return null;
    ...
    const freqOptions: Array<{ name: string; value: number }> = [
            ...
            <div class="input-group">
              ...
              <div class="input-box">
                ...
                <input
                  ...
                  type="text"
                  .value=${this.dose}
                  @input=${(e: Event) => (this.dose = (e.target as HTMLInputElement).value)}
