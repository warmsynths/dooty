...
let DootyPetSwitcher = class DootyPetSwitcher extends LitElement {
...
DootyPetSwitcher = __decorate([
    customElement('dooty-pet-switcher')
], DootyPetSwitcher);
export { DootyPetSwitcher };
//# sourceMappingURL=dooty-pet-switcher.js.map