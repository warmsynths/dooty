...
let DootyInvite = class DootyInvite extends LitElement {
    constructor() {
        super(...arguments);
        this.selectedRole = 'Full member';
        this.currentCode = 'K7M4Q9';
...
__decorate([
    state()
], DootyInvite.prototype, "selectedRole", void 0);
__decorate([
    state()
], DootyInvite.prototype, "currentCode", void 0);
__decorate([
    state()
], DootyInvite.prototype, "isGenerating", void 0);
DootyInvite = __decorate([
    customElement('dooty-invite')
], DootyInvite);
export { DootyInvite };
//# sourceMappingURL=dooty-invite.js.map