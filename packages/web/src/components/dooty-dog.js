...
let DootyDog = class DootyDog extends LitElement {
    constructor() {
        super(...arguments);
        this.medDone = { 0: true, 1: false, 2: false };
        this.uncheckState = {};
    }
  ...
  `; }
    ...
    renderWeightChart(isKo) {
      ...
      `;
        ...
        const dataPoints = rawEvents.map((e) => {
    ...
    render() {
        ...
        const displayMeds = uniqueMeds.length > 0
            ? uniqueMeds.map((e) => {
                const d = new Date(e.timestamp);
        ...
        const displayVets = allVetEvents.length > 0
            ? allVetEvents.map((v) => {
...
__decorate([
    state()
], DootyDog.prototype, "medDone", void 0);
__decorate([
    state()
], DootyDog.prototype, "uncheckState", void 0);
DootyDog = __decorate([
    customElement('dooty-dog')
], DootyDog);
export { DootyDog };
//# sourceMappingURL=dooty-dog.js.map